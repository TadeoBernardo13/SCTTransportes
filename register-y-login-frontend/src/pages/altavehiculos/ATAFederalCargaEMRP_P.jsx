...
function ATAFederalCargaEResiduosP() {
      ...
      <div className="d-flex">
        ...
        <div className="content p-4">
          <h1 className="fs-3">
            ...
            AUTOTRANSPORTE FEDERAL DE CARGA ESPECIALIZADA PARA EL TRANSPORTE DE
          ...
          <button
            onClick={() =>
              navigate(
                "/altavehiculoadicionalcargaespecializadaresiduospeligrosos"
              )
            }
...
export default ATAFederalCargaEResiduosP;
