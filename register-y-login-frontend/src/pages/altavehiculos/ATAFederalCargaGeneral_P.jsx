...
function ATAFederalCargaGeneralP() {
  ...
  const [inputs_P, setInputs_P] = useState({
    ...
    nombreATA_P:
      "ALTA DE VEHICULOS ADICIONALES AL PERMISO PARA EL SERVICIO DE AUTOTRANSPORTE FEDERAL DE CARGA GENERAL",
    justificacion_P: "",
    estado: "PENDIENTE",
  });
  const {
  ...
  const onSubmit_P = async (e) => {
    ...
    if (
      ...
      await axios
        .post("http://localhost:4000/pendientes/pendientes", Pendiente)
        .then((res) => {
          const { data } = res;
      ...
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <form onSubmit={(e) => onSubmit_P(e)}>
            ...
            <button
              onClick={() => navigate(`/altavehiculoadicionalcargageneral`)}
...
export default ATAFederalCargaGeneralP;
